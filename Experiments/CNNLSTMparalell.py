# -*- coding: utf-8 -*-
"""
Created on Fri Dec 20 11:47:47 2019
...
inputs_train, targets_train, inputs_val, targets_val, inputs_test, targets_test = DataLoader2.data_prep(r'D:\Desk\DTU\DeepLearn\DLProj\Fruedal data.xlsx',
                                                                                            day='weekday',
                                                                                            start_time=0,
                                                                                            end_time=6,
                                                                                            num_days_seq = 60,
...
scale = inputs_val/np.max(inputs_val)
means = np.zeros(inputs_val.shape[0])
